...
<div class="grids">
	<div class="grid-6">
		<div id="customer_login" class="box woocommerce-default-form">

			<?php echo qualia_divider( array( 'mode' => 'bold' ), __( 'Login', 'woocommerce' ) . ' &nbsp; ' ); ?>
	...
	<div class="grid-6">
		<div id="customer_register" class="box woocommerce-default-form">

			<?php echo qualia_divider( array( 'mode' => 'bold' ), __( 'Register', 'woocommerce' ) . ' &nbsp; ' ); ?>
