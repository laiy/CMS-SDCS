<?php
/**
 * Overriding WooCommerce Template: cart/shipping-calculator
 */
...
<div class="shipping-calculator box">

	<?php do_action( 'woocommerce_before_shipping_calculator' ); ?>
	
	<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
		
		<?php echo qualia_divider( array( 'mode' => 'bold' ), __( 'Calculate Shipping', 'woocommerce' ) . ' &nbsp; ' ); ?>

		<section class="shipping-calculator-form woocommerce-default-form">
			...
			<p><button type="submit" name="calc_shipping" value="1" class="vp-button vp-background-strong vp-color-base button"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
