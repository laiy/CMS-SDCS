<?php
/**
 * Overriding WooCommerce Template: cart/cross-sell
 */
		...
		<div class="grids">
			<div class="grid-8">
				...
				<div class="vp-table vp-mode-row-with-border">
					<table class="shop_table cart-table cart" cellspacing="0">
						<thead>
							<tr>
								...
								<th colspan="6" class="actions">
									...
									<div class="grids">
										...
										<div class="grid-4 right">
											<input type="submit" class="vp-button vp-background-strong vp-color-base" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>" />
