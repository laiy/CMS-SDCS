...
class Qualia_Widget_Recent_Posts extends WP_Widget {

	function __construct() {
		parent::__construct(
			'qualia_recent_posts',
			__('Qualia Recent Posts', 'qualia_td'),
			array('description' => __('Enhanced Recent Posts Widget', 'qualia_td'))
		);
	...
	public function widget($args, $instance) {
		$cache = wp_cache_get('widget_qualia_recent_posts', 'widget');
		...
		wp_cache_set('widget_qualia_recent_posts', $cache, 'widget');
	}
...
// register
function register_widget_qualia_recent_posts() {
    register_widget('Qualia_Widget_Recent_Posts');
}
add_action('widgets_init', 'register_widget_qualia_recent_posts');