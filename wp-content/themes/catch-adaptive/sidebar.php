		...
		<aside class="sidebar sidebar-primary widget-area" role="complementary">
			...
			if ( is_active_sidebar( 'primary-sidebar' ) ) {
				...
				if ( current_user_can( 'edit_theme_options' ) ) { ?>
					<section id="widget-default-text" class="widget widget_text">	
						<div class="widget-wrap">
		                	<h4 class="widget-title"><?php _e( 'Primary Sidebar Widget Area', 'catchadaptive' ); ?></h4>
		           		
		           			<div class="textwidget">
		                   		<p><?php _e( 'This is the Primary Sidebar Widget Area if you are using a two column site layout option.', 'catchadaptive' ); ?></p>
		                   		<p><?php printf( __( 'By default it will load Search and Archives widgets as shown below. You can add widget to this area by visiting your <a href="%s">Widgets Panel</a> which will replace default widgets.', 'catchadaptive' ), admin_url( 'widgets.php' ) ); ?></p>
		                 	</div>
		           		</div><!-- .widget-wrap -->
				...
				<section class="widget widget_archive" id="default-archives">
					<div class="widget-wrap">
						<h4 class="widget-title"><?php _e( 'Archives', 'catchadaptive' ); ?></h4>
						<ul>
