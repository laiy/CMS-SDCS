	...
	public function show() {
	    ...
	    <div id="catchadaptive-ui-tabs" class="ui-tabs">
		    <ul class="catchadaptive-ui-tabs-nav" id="catchadaptive-ui-tabs-nav">
		    	<li><a href="#frag1"><?php _e( 'Layout Options', 'catchadaptive' ); ?></a></li>
		    	<li><a href="#frag2"><?php _e( 'Select Sidebar', 'catchadaptive' ); ?></a></li>
		    	<li><a href="#frag3"><?php _e( 'Header Featured Image Options', 'catchadaptive' ); ?></a></li>
		    	<li><a href="#frag4"><?php _e( 'Single Page/Post Image Layout ', 'catchadaptive' ); ?></a></li>
		    </ul> 
...
$catchadaptive_metabox = new CatchAdaptiveMetaBox( 
									...
									__( 'Catch Adaptive Options', 'catchadaptive' ), //metabox title
